...
export const Logo: React.FC<LogoProps> = ({
  ...
  const subTextColor = isDark ? 'text-[#087A5A]' : 'text-[#087A5A]';
  const pinColor = isDark ? '#FFFFFF' : '#071A2B';
  const globeBg = isDark ? '#071A2B' : '#03111D';
  ...
  const Emblem = (
    ...
    >
      ...
      <g transform="translate(52, 33) rotate(-35)">
        <path d="M0 -15 L3.5 -3 L3.5 14 L0 11 L-3.5 14 L-3.5 -3 Z" fill="#087A5A" />
        <path d="M0 -2 L19 10 L16 13 L0 5 L-16 13 L-19 10 Z" fill="#04513E" />
        <path d="M0 8 L7 16 L4 17 L0 13 L-4 17 L-7 16 Z" fill="#087A5A" />
        <line x1="0" y1="13" x2="0" y2="23" stroke="#087A5A" strokeWidth="2.5" strokeLinecap="round" opacity="0.9" />
      </g>
    </svg>
  );
