...
export const Logo: React.FC<LogoProps> = ({
  ...
  const globeBg = isDark ? '#00174D' : '#00174D';
  ...
  const subSizes = {
    ...
    md: 'text-[8.5px] tracking-[0.15em]',
    lg: 'text-[10px] tracking-[0.16em]',
    xl: 'text-[12px] tracking-[0.18em]',
  };

  // SVG Emblem matching exact shape from brand mark
  const Emblem = (
    <svg
    ...
    >
      ...
      <ellipse cx="50" cy="40" rx="10" ry="19" stroke="#00A859" strokeWidth="1.8" fill="none" opacity="0.9" />
      <line x1="31" y1="40" x2="69" y2="40" stroke="#00A859" strokeWidth="1.8" opacity="0.9" />
      <ellipse cx="50" cy="40" rx="19" ry="8" stroke="#00A859" strokeWidth="1.5" strokeDasharray="3 2" fill="none" opacity="0.8" />

      {/* Jet Airplane taking off upward right */}
      <g transform="translate(52, 33) rotate(-35)">
        <path d="M0 -15 L3.5 -3 L3.5 14 L0 11 L-3.5 14 L-3.5 -3 Z" fill="#00A859" />
        <path d="M0 -2 L19 10 L16 13 L0 5 L-16 13 L-19 10 Z" fill="#007A3E" />
        <path d="M0 8 L7 16 L4 17 L0 13 L-4 17 L-7 16 Z" fill="#00A859" />
        <line x1="0" y1="13" x2="0" y2="23" stroke="#00A859" strokeWidth="2.5" strokeLinecap="round" opacity="0.9" />
      </g>
    </svg>
  );
