...
export const ServicesSection: React.FC<ServicesSectionProps> = ({ onOpenApply }) => {
  return (
    <section id="solutions" className="py-20 lg:py-28 bg-white border-b border-[#071A2B]/10 scroll-mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14 pb-8 border-b border-[#071A2B]/8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          {/* FEATURED SERVICE: Student Loans / Education Financing (Large Asymmetric Prominence - 7 cols) */}
          <div className="lg:col-span-7 bg-[#F8F7F3] border border-[#071A2B]/15 rounded-lg p-7 sm:p-9 flex flex-col justify-between shadow-xs hover:border-[#087A5A]/50 transition-all">
            <div className="space-y-6">
              ...
              {/* Integrated Real African Student Image Asset */}
              <div className="relative rounded-md overflow-hidden border border-[#071A2B]/10 h-52 sm:h-60 bg-white">
                <img
                  src={studentImage}
                  alt="Nigerian university scholar studying successfully with Emunahh-Invest loan"
                  className="w-full h-full object-cover object-center"
                />
                <div className="absolute inset-x-0 bottom-0 p-3 bg-gradient-to-t from-[#071A2B]/90 to-transparent text-white text-[11px] font-medium">
                  Direct Institutional Remittance · Federal, State & Private Campuses
                </div>
              </div>

              {/* Clear Bullet Highlights */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1 text-xs text-[#17202A] font-medium">
                ...
                <div className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-[#087A5A] shrink-0 mt-0.5" />
                  <span>Accredited federal, state & private universities</span>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-[#087A5A] shrink-0 mt-0.5" />
            ...
            {/* Action Bar */}
            <div className="pt-6 mt-6 border-t border-[#071A2B]/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <Link
                to="/student-loans"
                className="inline-flex items-center text-xs font-bold text-[#087A5A] hover:text-[#04513E] transition-colors"
              >
                <span>View Full Student Loan Structure & Requirements</span>
                <ArrowUpRight className="w-4 h-4 ml-1" />
              </Link>
              
              <Link
                to="/apply"
                className="inline-flex items-center justify-center px-5 py-2.5 text-xs font-bold text-white bg-[#071A2B] hover:bg-[#087A5A] rounded-md transition-colors shadow-xs"
              >
                Apply for Loan
              </Link>
            </div>
          ...
          {/* SUPPORTING SERVICES (5 cols): Investment & Commercial Solutions */}
          <div className="lg:col-span-5 space-y-6">
            
            {/* Supporting 1: Investment Services */}
            <div className="bg-[#F8F7F3] border border-[#071A2B]/15 rounded-lg p-6 sm:p-7 flex flex-col justify-between shadow-xs hover:border-[#087A5A]/50 transition-all">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                ...
                <h3 className="text-xl font-bold text-[#071A2B] tracking-tight">
                  Investment Services
                </h3>
                <p className="text-xs sm:text-sm text-[#17202A]/80 leading-relaxed">
                ...
                <div className="space-y-1.5 pt-2 text-xs text-[#17202A]/85">
              ...
              <div className="pt-4 mt-4 border-t border-[#071A2B]/10">
                <Link
                  to="/investments"
                  className="inline-flex items-center text-xs font-bold text-[#087A5A] hover:text-[#04513E] transition-colors"
                >
            ...
            <div className="bg-[#F8F7F3] border border-[#071A2B]/15 rounded-lg p-6 sm:p-7 flex flex-col justify-between shadow-xs hover:border-[#087A5A]/50 transition-all">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="w-8 h-8 rounded-md bg-[#071A2B]/10 text-[#071A2B] flex items-center justify-center">
