        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 space-y-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-7 rounded-xl border border-gray-200 space-y-3 shadow-2xs hover:border-[#087A5A]/40 transition-colors">
              ...
              <h3 className="text-base font-bold text-[#071A2B]">Salary-Backed Liquidity</h3>
            ...
            <div className="bg-white p-7 rounded-xl border border-gray-200 space-y-3 shadow-2xs hover:border-[#087A5A]/40 transition-colors">
              <HeartHandshake className="w-6 h-6 text-[#087A5A]" />
              <h3 className="text-base font-bold text-[#071A2B]">Family Milestone Support</h3>
              <p className="text-xs text-gray-600 leading-relaxed font-normal">
            ...
            <div className="bg-white p-7 rounded-xl border border-gray-200 space-y-3 shadow-2xs hover:border-[#087A5A]/40 transition-colors">
              ...
              <h3 className="text-base font-bold text-[#071A2B]">Transparent Terms</h3>
              <p className="text-xs text-gray-600 leading-relaxed font-normal">
