      ...
      <section className="py-14 lg:py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-xl bg-white border border-gray-200 space-y-2.5 shadow-2xs">
              <Lock className="w-6 h-6 text-[#00A859]" />
              <h3 className="text-sm font-bold text-[#00174D]">Strict Confidentiality</h3>
            ...
            <div className="p-6 rounded-xl bg-white border border-gray-200 space-y-2.5 shadow-2xs">
              <Database className="w-6 h-6 text-[#002B99]" />
              <h3 className="text-sm font-bold text-[#00174D]">Underwriting Security</h3>
              <p className="text-xs text-gray-600 leading-relaxed">
            ...
            <div className="p-6 rounded-xl bg-white border border-gray-200 space-y-2.5 shadow-2xs">
              <EyeOff className="w-6 h-6 text-[#00A859]" />
              <h3 className="text-sm font-bold text-[#00174D]">Zero Public Harassment</h3>
              <p className="text-xs text-gray-600 leading-relaxed">
          ...
          <div className="space-y-10 text-gray-700 text-sm leading-relaxed">
            ...
            <div className="space-y-3 pb-8 border-b border-gray-200">
              <h2 className="text-xl font-bold text-[#00174D]">1. Information We Collect</h2>
              <p>
            ...
            <div className="space-y-3 pb-8 border-b border-gray-200">
              <h2 className="text-xl font-bold text-[#00174D]">2. How Your Data Is Used</h2>
            ...
            <div className="space-y-3 pb-8 border-b border-gray-200">
              <h2 className="text-xl font-bold text-[#00174D]">3. Data Retention & Protection</h2>
              <p>
            ...
            <div className="space-y-3">
              <h2 className="text-xl font-bold text-[#00174D]">4. Inquiries & Data Privacy Officer</h2>
              <p>
